...
const routes: SitemapEntry[] = [
  ...
  { path: "/case-studies", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-08-08" },
  { path: "/case-studies/thermal-render-specialists", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-08-08" },
  { path: "/case-studies/focus-refurbishment", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-08-08" },
  ...
  { path: "/blog/is-bark-worth-it-tradesmen", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-28" },
  { path: "/blog/is-bark-worth-it-plumbers", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-28" },
  { path: "/blog/is-bark-worth-it-electricians", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-28" },
  { path: "/blog/is-bark-worth-it-landscapers", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-28" },
  { path: "/blog/google-ads-for-tradesmen-uk", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-06-04" },
  { path: "/blog/is-checkatrade-worth-it-2025", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-28" },
  { path: "/blog/how-to-get-more-google-reviews-tradesman", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-06-19" },
  { path: "/blog/mybuilder-vs-checkatrade", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-27" },
  { path: "/blog/bark-vs-checkatrade", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-28" },
  { path: "/blog/how-much-does-checkatrade-cost", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-27" },
  { path: "/blog/is-rated-people-worth-it", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-28" },
  { path: "/blog/how-much-do-bark-credits-cost", changeFrequency: "monthly", priority: 0.8, lastModified: "2026-07-27" },
  { path: "/about", changeFrequency: "monthly", priority: 0.6, lastModified: "2026-07-06" },
  // Trade landing pages
  { path: "/window-cleaners", changeFrequency: "monthly", priority: 0.9, lastModified: "2026-07-28" },
  { path: "/roofers", changeFrequency: "monthly", priority: 0.9, lastModified: "2026-07-28" },
  ...
  { path: "/landscapers", changeFrequency: "monthly", priority: 0.9, lastModified: "2026-07-28" },
