...
export const metadata: Metadata = buildMetadata({
  title: "Electrician Leads Without Checkatrade or Bark",
  description:
...
export default function ElectriciansPage() {
  ...
  const breadcrumbSchema = getBreadcrumbSchema([
    ...
    { name: "Electrician Marketing", url: `${BUSINESS_URL}${canonicalPath}` },
  ])
    ...
    <main className="min-h-screen overflow-x-hidden">
      ...
      <article className="pb-16 pt-28 sm:pb-20 sm:pt-32 lg:pb-24 lg:pt-36">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-0">
          ...
          <RelatedTrades currentHref="/electricians" />
